...
<cfoutput query="getlogin">		
	...
	<tr>
<td>
<cfform action="admin4a.cfm" method="POST">
			<cfinput type="submit" value="Update " name="b2" style="width: 100; height: 24; background-color: white;"  size=35>
			<cfinput type="Hidden" name="pass" value="#getpass.password#">
			<cfinput type="Hidden" name="user" value="#getpass.username#">
			<cfinput type="hidden" name="level" value="#getpass.adminlevel#">
		...
		<td valign="top" align="left"><font size="5">#adminlevel#</font></td>
	</tr>
</cfoutput>	
</table>
</center>	
